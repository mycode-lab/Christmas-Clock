document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTime() {
        ...
        eventDateEl.innerHTML = `<i class="fas fa-calendar"></i> Christmas Date: ${christmas.toLocaleDateString()}`;
        eventDayEl.innerHTML = `<i class="fas fa-calendar-check"></i> Christmas Day: ${christmas.toLocaleDateString(undefined, { weekday: 'long' })}`;
        ...
        countdownEl.innerHTML = `<i class="fas fa-hourglass-half"></i> Time left for Christmas: ${monthsLeft}m ${daysLeft}d ${hoursLeft}h ${minutesLeft}m ${secondsLeft}s`;
